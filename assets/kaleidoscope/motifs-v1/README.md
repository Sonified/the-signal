...
Every motif uses a centered `[0.5, 0.5]` anchor and a canonical upward orientation. Tile coordinates and names are recorded in `manifest.json`. It is Image set 6 in the kaleidoscope (`v1/gpu/kaleido.js` ATLAS_SETS).
