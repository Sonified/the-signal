# Kaleidoscope set 12: Peaceful shapes

`peaceful-shapes-128.png` is a 1024 × 1024 transparent atlas of 64 shapes, each centred in a 128 × 128 tile with at least 12 px of transparent padding. Read tiles left to right, then down; names are in `manifest.json`. It is Image set 12 in the kaleidoscope (`v1/gpu/kaleido.js` ATLAS_SETS).
...
NODE_PATH=/tmp/the-signal-atlas-tools/node_modules node tools/pack-kaleidoscope-motifs.cjs peaceful-shapes
```
