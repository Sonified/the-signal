# Kaleidoscope set 2: Petal specimens

`set-2-128.png` is a 1024 × 1024 transparent atlas of 64 flower petals, each centred in a 128 × 128 tile with at least 12 px of transparent padding. Read tiles left to right, then down; names are in `manifest.json`. It is Image set 2 in the kaleidoscope (`v1/gpu/kaleido.js` ATLAS_SETS).
...
NODE_PATH=/tmp/the-signal-atlas-tools/node_modules node tools/pack-kaleidoscope-motifs.cjs petal-specimens
```
